...
// 1. Adding prototype "add" to the display that adds new books
display.prototype.add = function(sampleBook){
...
// 2. Adding prototype "clear" to the display that clear the form inputs
display.prototype.clear = function(){
    let libraryForm = document.getElementById("libraryForm");
    libraryForm.reset();
}

// 3. Adding prototype "validate" to the display that validate the new book that is going to be added
display.prototype.validate = function(sampleBook){
...
// 4. Adding prototype "show" to the display that show the alert of Error/Success
display.prototype.show = function(result){
    let resultHTML;
    if(result === 'success'){
        resultHTML = `
